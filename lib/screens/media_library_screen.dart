...
class _VideosTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (items.isEmpty) return _EmptyState(label: 'No videos yet');
...
class _AudioTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (items.isEmpty) return _EmptyState(label: 'No audio yet');
...
class _BooksTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (items.isEmpty) return _EmptyState(label: 'No books yet');
